...
public class GlobalSimulation{
    ...
    public static final int ARRIVAL_1 = 1, DEPARTURE_1 = 2, MEASURE = 3, DEPARTURE_2=4; // The events, add or remove if needed! // The events, add or remove if needed!
	...
	public static void insertEvent(int type, double TimeOfEvent, int server){  // Just to be able to skip dot notation
		eventList.InsertEvent(type, TimeOfEvent, server);
	}
}