...
public class GlobalSimulation{
	...
	public static final int ARRIVAL_A = 1, ARRIVAL_B=2, DEPARTURE_A = 3, DEPARTURE_B=4, MEASURE = 5;  // The events, add or remove if needed!
	public static double time = 0; // The global time variable
	public static double processor_time = 0; // Time for seeing if processor busy or not 
